...
public class Error extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        error = new org.example.Custom.AnimatedTextField();
        ...
        blurBackground1.setImage(new javax.swing.ImageIcon(getClass().getResource("/Error.png"))); // NOI18N
        ...
        blurBackground1.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 10, 30, 30));

        error.setForeground(new java.awt.Color(204, 204, 204));
        error.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        error.setEnableUnderline(false);
        error.setEnabled(false);
        error.setFont(new java.awt.Font("Century", 0, 20)); // NOI18N
        blurBackground1.add(error, new org.netbeans.lib.awtextra.AbsoluteConstraints(85, 54, 300, 80));

        getContentPane().add(blurBackground1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, -5, 460, 210));
    ...
    private org.example.Custom.AnimatedTextField error;
