 ...
 */
public class Warming extends javax.swing.JFrame {

    String mensaje;

    public Warming(String mensaje) {
    ...
    private void initComponents() {
        ...
        blurBackground1.setImage(new javax.swing.ImageIcon(getClass().getResource("/Warming.png"))); // NOI18N
        ...
        blurBackground1.add(warming, new org.netbeans.lib.awtextra.AbsoluteConstraints(85, 54, 300, 80));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Warming.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
